...
├── cross-rule-deduplication.md          ← spec for consolidating overlapping rule fires
├── identity-resolution-pattern.md       ← reference design for cross-domain identity normalization
